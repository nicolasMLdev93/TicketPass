      ...
      {loggingOut && (
        <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            <FiLoader className="w-10 h-10 text-amber-400 animate-spin" />
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-500 text-xs mt-1">Hasta pronto</p>
            </div>
          </div>
        </div>
      )}
      ...
      >
        ...
        <div className="border-t border-neutral-800 p-3">
          <button
            ...
            disabled={loggingOut}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-neutral-400 hover:text-red-400 hover:bg-red-500/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loggingOut ? (
